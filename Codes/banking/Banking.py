...
df.head()
df.rename(columns = {'Exited':'label_1'}, inplace = True)
df.head()
...
modified_train['label_1'].value_counts()

modified_train.to_csv('modified_train_banking.csv')
...
result_LSTM_b=pd.DataFrame(columns = results_column_names)
writer_LSTM_b = pd.ExcelWriter('max_cardinal_boosting_results_LSTM.xlsx')
...
result_LSTM=pd.DataFrame(columns = results_column_names_with_train)
writer_LSTM = pd.ExcelWriter('max_cardinal_results_LSTM.xlsx')
...
auc_test_CART=roc_auc_score(y_test, y_pred_test_CART)
tn_test_CART, fp_test_CART, fn_test_CART, tp_test_CART = confusion_matrix(y_test, y_pred_test_CART).ravel()
auc_train_CART=roc_auc_score(Y_train, y_pred_train_CART)
...
auc_train_RBF=roc_auc_score(Y_train, y_pred_train_RBF)
...
auc_test_LINEAR=roc_auc_score(y_test, y_pred_test_LINEAR)
tn_test_LINEAR, fp_test_LINEAR, fn_test_LINEAR, tp_test_LINEAR = confusion_matrix(y_test, y_pred_test_LINEAR).ravel()
auc_train_LINEAR=roc_auc_score(Y_train, y_pred_train_LINEAR)
...
auc_test_1_KNN=roc_auc_score(y_test, y_pred_test_1_KNN)
tn_test_1_KNN, fp_test_1_KNN, fn_test_1_KNN, tp_test_1_KNN = confusion_matrix(y_test, y_pred_test_1_KNN).ravel()
auc_train_1_KNN=roc_auc_score(Y_train, y_pred_train_1_KNN)
...
auc_test_3_KNN=roc_auc_score(y_test, y_pred_test_3_KNN)
tn_test_3_KNN, fp_test_3_KNN, fn_test_3_KNN, tp_test_3_KNN = confusion_matrix(y_test, y_pred_test_3_KNN).ravel()
auc_train_3_KNN=roc_auc_score(Y_train, y_pred_train_3_KNN)
...
auc_test_5_KNN=roc_auc_score(y_test, y_pred_test_5_KNN)
tn_test_5_KNN, fp_test_5_KNN, fn_test_5_KNN, tp_test_5_KNN = confusion_matrix(y_test, y_pred_test_5_KNN).ravel()
auc_train_5_KNN=roc_auc_score(Y_train, y_pred_train_5_KNN)
...
auc_test_GBM_50=roc_auc_score(y_test, y_pred_test_GBM_50)
tn_test_GBM_50, fp_test_GBM_50, fn_test_GBM_50, tp_test_GBM_50 = confusion_matrix(y_test, y_pred_test_GBM_50).ravel()
auc_train_GBM_50=roc_auc_score(Y_train, y_pred_train_GBM_50)
...
auc_test_GBM_100=roc_auc_score(y_test, y_pred_test_GBM_100)
tn_test_GBM_100, fp_test_GBM_100, fn_test_GBM_100, tp_test_GBM_100 = confusion_matrix(y_test, y_pred_test_GBM_100).ravel()
auc_train_GBM_100=roc_auc_score(Y_train, y_pred_train_GBM_100)
...
auc_test_GBM_200=roc_auc_score(y_test, y_pred_test_GBM_200)
tn_test_GBM_200, fp_test_GBM_200, fn_test_GBM_200, tp_test_GBM_200 = confusion_matrix(y_test, y_pred_test_GBM_200).ravel()
auc_train_GBM_200=roc_auc_score(Y_train, y_pred_train_GBM_200)
...
auc_test_LR=roc_auc_score(y_test, y_pred_test_LR)
tn_test_LR, fp_test_LR, fn_test_LR, tp_test_LR= confusion_matrix(y_test, y_pred_test_LR).ravel()
auc_train_LR=roc_auc_score(Y_train, y_pred_train_LR)
...
auc_test_RNF=roc_auc_score(y_test, y_pred_test_RNF)
tn_test_RNF, fp_test_RNF, fn_test_RNF, tp_test_RNF= confusion_matrix(y_test, y_pred_test_RNF).ravel()
auc_train_RNF=roc_auc_score(Y_train, y_pred_train_RNF)
...
auc_test_CatBoost=roc_auc_score(y_test, y_pred_test_CatBoost)
tn_test_CatBoost, fp_test_CatBoost, fn_test_CatBoost, tp_test_CatBoost= confusion_matrix(y_test, y_pred_test_CatBoost).ravel()
auc_train_CatBoost=roc_auc_score(Y_train, y_pred_train_CatBoost)
...
fpr, tpr, tr = roc_curve(df_actual_predicted_CART['label_1'], df_actual_predicted_CART['y_pred_proba_CART'])
auc_CART = roc_auc_score(df_actual_predicted_CART['label_1'], df_actual_predicted_CART['y_pred_proba_CART'])
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_CART)
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_KNN_1)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_KNN_3)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_KNN_5)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_GBM_50)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
fpr, tpr, tr = roc_curve(df_actual_predicted_GBM_100['label_1'], df_actual_predicted_GBM_100['y_pred_proba_GBM_100'])
auc_GBM_100 = roc_auc_score(df_actual_predicted_GBM_100['label_1'], df_actual_predicted_GBM_100['y_pred_proba_GBM_100'])
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_GBM_100)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_GBM_200)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_RBF)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_LINEAR)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_RNF)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.plot(fpr, tpr, label='AUC = %0.4f' %auc_catboost)
plt.plot(fpr, fpr, linestyle = '--', color='k')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for LSTM', size = 10)
plt.legend()
...
fpr_LSTM, tpr_LSTM, _ = metrics.roc_curve(df_actual_predicted_LSTM['label_1'], df_actual_predicted_LSTM['y_pred_proba_LSTM'])
...
df_LR = {'fpr_LR': fpr_LR, 'tpr_LR': tpr_LR}
LR = pd.DataFrame(df_LR)

df_GMB_50 = {'fpr_GBM_50': fpr_GBM_50, 'tpr_GBM_50': tpr_GBM_50}
GMB_50 = pd.DataFrame(df_GMB_50)

df_GMB_100 = {'fpr_GBM_100': fpr_GBM_100, 'tpr_GBM_100': tpr_GBM_100}
GMB_100 = pd.DataFrame(df_GMB_100)

df_GMB_200 = {'fpr_GBM_200': fpr_GBM_200, 'tpr_GBM_200': tpr_GBM_200}
GMB_200 = pd.DataFrame(df_GMB_200)

df_KNN_1 = {'fpr_KNN_1': fpr_KNN_1, 'tpr_KNN_1': tpr_KNN_1}
KNN_1 = pd.DataFrame(df_KNN_1)

df_KNN_3 = {'fpr_KNN_3': fpr_KNN_3, 'tpr_KNN_3': tpr_KNN_3}
KNN_3 = pd.DataFrame(df_KNN_3)

df_KNN_5 = {'fpr_KNN_5': fpr_KNN_5, 'tpr_KNN_5': tpr_KNN_5}
KNN_5 = pd.DataFrame(df_KNN_5)

df_XGB = {'fpr_XGB': fpr_XGB, 'tpr_XGB': tpr_XGB}
XGB = pd.DataFrame(df_XGB)

df_RBF = {'fpr_RBF': fpr_RBF, 'tpr_RBF': tpr_RBF}
RBF = pd.DataFrame(df_RBF)

df_RNF = {'fpr_RNF': fpr_RNF, 'tpr_RNF': tpr_RNF}
RNF = pd.DataFrame(df_RNF)

df_CART = {'fpr_CART': fpr_CART, 'tpr_CART': tpr_CART}
CART = pd.DataFrame(df_CART)

df_catboost = {'fpr_catboost': fpr_catboost, 'tpr_catboost': tpr_catboost}
catboost = pd.DataFrame(df_catboost)

df_LINEAR = {'fpr_LINEAR': fpr_LINEAR, 'tpr_LINEAR': tpr_LINEAR}
LINEAR = pd.DataFrame(df_LINEAR)

df_LStM = {'fpr_LSTM': fpr_LSTM, 'tpr_LSTM': tpr_LSTM}
LSTM = pd.DataFrame(df_LStM)
...
##########
precision_CART = precision_score(y_test, y_pred_test_CART, average=None)
precision_CART_weighted = precision_score(y_test, y_pred_test_CART, average='weighted')
precision_CART_micro = precision_score(y_test, y_pred_test_CART, average='micro')
balanced_accuracy_CART = balanced_accuracy_score(y_test, y_pred_test_CART)
...
f1_score_KNN_1 = f1_score(y_test,y_pred_test_1_KNN)
Accuracy_KNN_1 = accuracy_score(y_test,y_pred_test_1_KNN)
...
##########
precision_KNN_1 = precision_score(y_test, y_pred_test_1_KNN, average=None)
precision_KNN_1_weighted = precision_score(y_test, y_pred_test_1_KNN, average='weighted')
precision_KNN_1_micro = precision_score(y_test, y_pred_test_1_KNN, average='micro')
balanced_accuracy_KNN_1 = balanced_accuracy_score(y_test, y_pred_test_1_KNN)
...
f1_score_KNN_3 = f1_score(y_test,y_pred_test_3_KNN)
Accuracy_KNN_3 = accuracy_score(y_test,y_pred_test_3_KNN)
...
##########
precision_KNN_3 = precision_score(y_test, y_pred_test_3_KNN, average=None)
precision_KNN_3_weighted = precision_score(y_test, y_pred_test_3_KNN, average='weighted')
precision_KNN_3_micro = precision_score(y_test, y_pred_test_3_KNN, average='micro')
balanced_accuracy_KNN_3= balanced_accuracy_score(y_test, y_pred_test_3_KNN)
...
f1_score_KNN_5 = f1_score(y_test,y_pred_test_5_KNN)
Accuracy_KNN_5 = accuracy_score(y_test,y_pred_test_5_KNN)
...
##########
precision_KNN_5 = precision_score(y_test, y_pred_test_5_KNN, average=None)
precision_KNN_5_weighted = precision_score(y_test, y_pred_test_5_KNN, average='weighted')
precision_KNN_5_micro = precision_score(y_test, y_pred_test_5_KNN, average='micro')
balanced_accuracy_KNN_5 = balanced_accuracy_score(y_test, y_pred_test_5_KNN)
...
f1_score_GBM_50 = f1_score(y_test,y_pred_test_GBM_50)
Accuracy_GBM_50 = accuracy_score(y_test,y_pred_test_GBM_50)
...
##########
precision_GBM_50 = precision_score(y_test, y_pred_test_GBM_50, average=None)
precision_GBM_50_weighted = precision_score(y_test, y_pred_test_GBM_50, average='weighted')
precision_GBM_50_micro = precision_score(y_test, y_pred_test_GBM_50, average='micro')
balanced_accuracy_GBM_50 = balanced_accuracy_score(y_test, y_pred_test_GBM_50)
...
f1_score_GBM_100 = f1_score(y_test,y_pred_test_GBM_100)
Accuracy_GBM_100 = accuracy_score(y_test,y_pred_test_GBM_100)
...
##########
precision_GBM_100 = precision_score(y_test, y_pred_test_GBM_100, average=None)
precision_GBM_100_weighted = precision_score(y_test, y_pred_test_GBM_100, average='weighted')
precision_GBM_100_micro = precision_score(y_test, y_pred_test_GBM_100, average='micro')
balanced_accuracy_GBM_100 = balanced_accuracy_score(y_test, y_pred_test_GBM_100)
...
f1_score_GBM_200 = f1_score(y_test,y_pred_test_GBM_200)
Accuracy_GBM_200 = accuracy_score(y_test,y_pred_test_GBM_200)
...
##########
precision_GBM_200 = precision_score(y_test, y_pred_test_GBM_200, average=None)
precision_GBM_200_weighted = precision_score(y_test, y_pred_test_GBM_200, average='weighted')
precision_GBM_200_micro = precision_score(y_test, y_pred_test_GBM_200, average='micro')
balanced_accuracy_GBM_200 = balanced_accuracy_score(y_test, y_pred_test_GBM_200)
...
f1_score_SVC_RBF = f1_score(y_test,y_pred_test_RBF)
Accuracy_SVC_RBF = accuracy_score(y_test,y_pred_test_RBF)
...
##########
precision_SVC_RBF = precision_score(y_test, y_pred_test_RBF, average=None)
precision_SVC_RBF_weighted = precision_score(y_test, y_pred_test_RBF, average='weighted')
precision_SVC_RBF_micro = precision_score(y_test, y_pred_test_RBF, average='micro')
balanced_accuracy_SVC_RBF = balanced_accuracy_score(y_test, y_pred_test_RBF)
...
f1_score_SVC_Linear = f1_score(y_test,y_pred_test_LINEAR)
Accuracy_SVC_Linear = accuracy_score(y_test,y_pred_test_LINEAR)
...
##########
precision_SVC_Linear = precision_score(y_test, y_pred_test_LINEAR, average=None)
precision_SVC_Linear_weighted = precision_score(y_test, y_pred_test_LINEAR, average='weighted')
precision_SVC_Linear_micro = precision_score(y_test, y_pred_test_LINEAR, average='micro')
balanced_accuracy_SVC_Linear= balanced_accuracy_score(y_test, y_pred_test_LINEAR)
...
f1_score_XGBoost = f1_score(y_test,y_pred_test_XGB)
...
##########
precision_XGBoost = precision_score(y_test, y_pred_test_XGB, average=None)
precision_XGBoost_weighted = precision_score(y_test, y_pred_test_XGB, average='weighted')
precision_XGBoost_micro = precision_score(y_test, y_pred_test_XGB, average='micro')
balanced_accuracy_XGBoost = balanced_accuracy_score(y_test, y_pred_test_XGB)
...
f1_score_RNF = f1_score(y_test,y_pred_test_RNF)
Accuracy_RNF = accuracy_score(y_test,y_pred_test_RNF)
...
##########
precision_RNF = precision_score(y_test, y_pred_test_RNF, average=None)
precision_RNF_weighted = precision_score(y_test, y_pred_test_RNF, average='weighted')
precision_RNF_micro = precision_score(y_test, y_pred_test_RNF, average='micro')
balanced_accuracy_RNF = balanced_accuracy_score(y_test, y_pred_test_RNF)
...
##########
precision_LR = precision_score(y_test, y_pred_test_LR, average=None)
precision_LR_weighted = precision_score(y_test, y_pred_test_LR, average='weighted')
precision_LR_micro = precision_score(y_test, y_pred_test_LR, average='micro')
balanced_accuracy_LR = balanced_accuracy_score(y_test, y_pred_test_LR)
...
f1_score_CatBoost = f1_score(y_test,y_pred_test_CatBoost)
...
##########
precision_CatBoost = precision_score(y_test, y_pred_test_CatBoost, average=None)
precision_CatBoost_weighted = precision_score(y_test, y_pred_test_CatBoost, average='weighted')
precision_CatBoost_micro = precision_score(y_test, y_pred_test_CatBoost, average='micro')
balanced_accuracy_CatBoost = balanced_accuracy_score(y_test, y_pred_test_CatBoost)
...
final_results_based_on_AUC_Unsup_banking = result_Normal.sort_values(by=['AUC'], ascending=False)
final_results_based_on_AUC_Unsup_banking = final_results_based_on_AUC_Unsup_banking.reset_index(drop=True)
final_results_based_on_AUC_Unsup_banking = final_results_based_on_AUC_Unsup_banking.round(2)
final_results_based_on_AUC_Unsup_banking.to_csv('two_phase_resampling_banking_2.csv')
final_results_based_on_AUC_Unsup_banking

# Sample data
x = result_Normal['Model name']
y1 = result_Normal['balanced_accuracy']
y2 = result_Normal['accuracy']
y3 = result_Normal['f1_score']
...
# Plot the data
ax.plot(x, y1, label='Balanced_accuracy',marker='o', markerfacecolor='blue', markersize=8, color='blue')
ax.plot(x, y2, label='Accuracy', marker='o', markerfacecolor='green', markersize=8, color='green')
ax.plot(x, y3, label='F1_score', marker='o', markerfacecolor='purple', markersize=8, color='purple')
...
# Set the border of the legend box to black
legend.get_frame().set_edgecolor('black')


# Set the font size of the legend
plt.setp(legend.get_texts(), fontsize='10.5')
...
# Sample data
model_names = ['CART', 'KNN-1', 'KNN-3', 'KNN-5', 'GBM_50', 'GBM_100', 'GBM_200', 'SVC_RBF', 'SVC_Linear',
               'XGBoost', 'Random Forest', 'CatBoost', 'Logistic Regression', 'LSTM']
incorrect_percentages = result_Normal['incorrectly_percentage']
correct_percentages = result_Normal['correctly_percentage']

bar_width = 0.35

# Set the positions of the bars on the x-axis
r1 = np.arange(len(incorrect_percentages))
...
# Plot the bars
ax.bar(r1, incorrect_percentages, width=bar_width, label='Incorrect')
ax.bar(r2, correct_percentages, width=bar_width, label='Correct')

# Set the x-axis labels and ticks
ax.set_xticks([r + bar_width/2 for r in range(len(incorrect_percentages))])
...
# Set the title
ax.set_title('Percentage of Correct and Incorrect Predictions by Model')
ax.set_facecolor('white')


# Set the color of the legend labels to black
legend = ax.legend()
