...
df = df.drop(['OrderCount', 'HourSpendOnApp', 'Gender', 'CityTier'], axis = 1)
...
df_test.to_csv('test_online.csv')
...
modified_train.to_csv('modified_train_online_retail.csv')
...
print(classification_report(y_test, y_pred_test_1_KNN))
...
print(classification_report(y_test, y_pred_test_3_KNN))
...
plt.plot(fpr_LSTM,tpr_LSTM,label="LSTM, AUC="+str(auc), linewidth=3)
...
frames = [CART_reults, KNN_1_reults, KNN_3_reults, KNN_5_reults, GBM_50_reults, GBM_100_reults,
          GBM_200_reults, SVC_RBF_reults, SVC_Linear_results, XGBoost_reults, RNF_reults, CatBoost_reults,
          LR_reults, LSTM_reults]

result_Normal = pd.concat(frames)

final_results_based_on_AUC_Unsup_online_retail = result_Normal.sort_values(by=['AUC'], ascending=False)
final_results_based_on_AUC_Unsup_online_retail = final_results_based_on_AUC_Unsup_online_retail.reset_index(drop=True)
final_results_based_on_AUC_Unsup_online_retail.to_csv('results_two_phases_online.csv')
final_results_based_on_AUC_Unsup_online_retail.round(2)
